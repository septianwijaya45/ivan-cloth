                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-14 row">
                                                <div class="col-md-12">        
                                                    ...
                                                    <input type="text" name="kode_spk" id="kode_spk" class="form-control" value="{{$spk->kode_spk}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <div class="col-md-12">
                                                <input type="date" name="tanggal" id="tanggal" class="form-control" value="{{$spk->tanggal}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                                    ...
                                                    <div class="row">
                                                        <div class = "upload-img">
                                                            @foreach ($gambarSpk as $dt)
                                                                <div class = "uploaded-img col-md-6" id="{{$dt->uuid}}">
                                                                    <img src = "{{ url('/img/gambar/'.$dt->nama_foto) }}" width="600" class="text-center">
                                                                </div>
                                                                <div class="col-md-6 mb-3" id="btn-{{$dt->uuid}}">
                                                                    <button type="button" class="btn btn-danger "data-uuid="{{$dt->uuid}}" id="btn-hapus-gambar"> Hapus Gambar </button>
                                                                </div>
                                                            @endforeach
                                                        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#btn-tambah').on('click', function(){
                ...
                let hasil_potongan = $('#hasil_kain_potongan').val();
                let stok = $('#sisa_stok').val();
                let jumlah_kain = $('#hasil').val();
            ...
            $('#tabel_insert').on('click', '.remove-data', function(){
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        var _url = "{{ route('spk.deleteDetail', 'uuid') }}";
            ...
            $('#tabel_insert').on('click', '#edit-data', function(){
                ...
                $('#kode_spp').val(dt_detail.kode_spp).change();
                $('#tanggal').val(dt_detail.tanggal);
                $('#sisa_stok').val(dt_detail.stok);
                $('#hasil_kain_potongan').val(dt_detail.hasil_potongan);
                $('#kain_potongan_dipakai').val(dt_detail.kain_potongan_dipakai);
                $('#hasil').val(dt_detail.jumlah_kain);
                $('#gaji').val(dt_detail.gaji).change();
                $('#satuan').val(dt_detail.satuan).change();
                ...
                $.ajax({
                    url: "{{ url('surat-perintah-potong/data') }}/"+dt_detail.kode_spp,
                    // url: "{{ url('surat-perintah-potong/data-spp') }}?spp='"+data+"'",
                    method: "GET",
                    success: function(res){
                        $('#ukuran').empty();
                        ...
                        $('#warna').val(dt_detail.warna).change();
                    }
                })
            ...
            $('#btn-hapus-gambar').on('click', function(e){
                ...
                .then((result) => {
                    if(result.isConfirmed){
                        ...
                        $.ajax({
                            url         : "{{ url('surat-perintah-kain/delete-gambar-spk') }}/"+uuid,
                            method      : "DELETE",
                            success     : function(res){
                                Swal.fire(
                                    'Berhasil!',
